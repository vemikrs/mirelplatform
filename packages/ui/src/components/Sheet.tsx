...
>(({ className, ...props }, ref) => (
  <SheetPrimitive.Overlay
    className={cn(
      "fixed inset-0 z-50 bg-black/80 state-open:animate-fade-in state-closed:animate-fade-out",
      className
    )}
    {...props}
    ref={ref}
  ...
  "fixed z-50 gap-4 bg-background p-6 shadow-lg transition ease-in-out state-closed:duration-300 state-open:duration-500",
  {
    variants: {
      side: {
        ...
        bottom:
          "left-0 right-0 bottom-0 border-t state-closed:animate-slide-out-left state-open:animate-slide-in-left",
        ...
        right:
          "top-0 bottom-0 right-0 h-full w-3/4 border-l state-closed:animate-slide-out-right state-open:animate-slide-in-right sm:max-w-sm",
      },
    },
    defaultVariants: {
      side: "right",
