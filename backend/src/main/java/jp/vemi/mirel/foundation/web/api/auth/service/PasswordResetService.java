...
public class PasswordResetService {
    ...
    public String requestPasswordReset(String email, String requestIp, String userAgent) {
        ...
        log.info("Password reset requested for user: {} (SystemUser ID: {})", SanitizeUtil.forLog(email),
                systemUser.getId());
     ...
     * 
     * @param token
     *            Reset token (plain text from email)
     * @param newPassword
     *            New password
     */
    @Transactional
    ...
    private void sendPasswordResetEmail(String email, String token) {
        try {
            ...
            log.info("Password reset email sent to: {}", SanitizeUtil.forLog(email));
        } catch (Exception e) {
            log.error("Failed to send password reset email to: {}", SanitizeUtil.forLog(email), e);
