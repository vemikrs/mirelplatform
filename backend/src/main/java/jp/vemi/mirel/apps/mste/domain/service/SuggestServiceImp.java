...
public class SuggestServiceImp implements SuggestService {
            ...
            try {
                ...
                engine = TemplateEngineProcessor.create(
                        SteContext.standard(resultModel.fltStrStencilCd.selected,
                                isWildcard(requestedSerial) ? "" : requestedSerial),
    ...
    private void autoSelectFirst(ValueTextItems items) {
        if (items == null || CollectionUtils.isEmpty(items.items)) {
            return;
        }
        // 既存優先ルール再利用
    ...
    private void validateSelectedExists(ValueTextItems items) {
        ...
        if (StringUtils.isEmpty(items.selected)) {
            return;
        }
    ...
    private ApiResponse<SuggestResult> wrap(SuggestResult model) {
        ...
        ApiResponse<SuggestResult> response = (ApiResponse<SuggestResult>) (ApiResponse<?>) ApiResponse.builder()
                .data(w).build();
    ...
    protected static List<Map<String, Object>> mergeMapList(List<Map<String, Object>> list1,
        ...
        list1.forEach(dataElement -> {
            ...
            Map<String, Object> target = dataElement != null ? Maps.newLinkedHashMap(dataElement)
     ...
     */
    private ApiResponse<SuggestResult> createFallbackResponse(String stencilCd, String serialNo,
        ...
        try {
            ...
            minimalConfig.setCategoryId(
                    resultModel.fltStrStencilCategory != null ? resultModel.fltStrStencilCategory.selected : "");
